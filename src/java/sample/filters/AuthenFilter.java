...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        NON_AUTHEN_RESOURCES.add("CreateController");
        ...
        NON_AUTHEN_RESOURCES.add("checkout.jsp");
        NON_AUTHEN_RESOURCES.add("success.html");
        NON_AUTHEN_RESOURCES.add("oncancel.html");
    }
